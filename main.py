...
try:
    ...
    first_agent_class = getattr(module_agents, sys.argv[1] if len(sys.argv) > 1 else 'NegascoutAgent')
    second_agent_class = getattr(module_agents, sys.argv[2] if len(sys.argv) > 2 else 'NegascoutAgent')
